...
var mathArray = ["math19","math20", "math21", "math41", "math42", "math51", "math51m", "math52", "math53", "math41a", "math42a", "math51a", "math52a", "math53a", "math51h", "math52h", "math53h", "math104", "math106", "math109", "math113", "math115", "math120", "math121", "math131p", "math132", "cme100", "cme102", "cme104", "cme100a", "cme102a", "cme104a", "cme106", "cme108", "cme155a", "cme192", "cs103", "cs109", "cee101d", "cee201d", "cee203", "engr62", "engr154", "engr155a", "engr155b", "engr155c", "ms&e121", "ms&e120", "stats60", "stats110", "stats116", "ee178", "ee102b"];

// Array of all courses that fulfill the SOE science requirement
var scienceArray = ["bio41", "bio42", "bio43", "bio44x", "bio44y", "cee63", "cee64", "cee70", "chem31a", "chem31b", "chem31x", "chem33", "chem35", "chem36", "chem131", "chem135", "earthsys5", "earthsys10", "engr31", "ges1a", "ges1b", "ges1c", "physics21", "physics23", "physics25", "physics41", "physics43", "physics45", "physics42", "physics44", "physics46", "physics61", "physics63", "physics65", "physics62", "physics64", "physics67"];
...
var tisArray = ["sts101", "sts201", "engr130", "engr131", "engr145", "sts101q", "sts110", "sts112", "sts115", "bioe131", "classart113", "comm120w", "comm169", "cs181", "cs181w", "humbio174", "ms&e181", "ms&e193", "ms&e193w", "ms&e197", "polisci114s", "publpol122", "publpol194"];
...
var fundamentalsArray = ["engr10", "engr14", "engr15", "engr20", "cheme20", "engr25b", "cheme25b", "engr25e", "cheme25e", "engr30", "engr40", "engr40a", "engr40c", "engr40n", "engr40p", "ee41", "engr50", "engr50e", "engr50m", "engr60", "engr62", "ms&e111", "engr70b", "cs106b", "engr70x", "cs106x", "engr80", "engr90", "cee70"];
...
function meetsCore(course_array) {
	for (var i = 0; i < coreArray.length; i++) {
		if (coreArray[i] == "ee100") {
			if (!(courseTaken(course_array, coreArray[i]) || courseTaken(course_array, "ee100x"))) {
				return false;
			}
