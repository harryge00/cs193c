...
var SPECIALTY_COURSES_REQUIREMENT = 3;
...
var bioelectronicsAndBioimagingArray = ["ee122b", "ee124", "ee134", "ee168", "ee169", "ee202", "ee225"];

var circuitsAndDevicesArray = ["ee114", "ee116", "ee122a", "ee133", "ee212", "ee214b", "ee216", "ee271"];

var computerHardwareArray = ["ee109", "ee271", "ee273", "ee282", "cs107"];

var computerSoftwareArray = ["cs107", "cs108", "cs110", "cs140", "cs143", "cs145", "cs148", "cs194w", "ee284", "cs144"];

var musicArray = ["ee109", "ee264", "music256a", "music256b", "music420a", "music420b", "music421a", "music421b", "music422", "music424"];

var signalProcessingCommunicationsAndControlsArray = ["ee124", "ee133", "ee168", "ee169", "ee179", "ee261", "ee262", "ee263", "ee264", "ee265", "ee276", "ee278b", "ee279", "engr105", "engr205"];

var solidStatePhotonicsAndElectromagneticsArray = ["ee116", "ee134", "ee136", "ee141", "ee216", "ee222", "ee223", "ee228", "ee235", "ee242", "ee247", "ee268"];

// Array of all courses that fulfill the EE Capstone Design requirement
var capstoneArray = ["ee109", "ee133", "ee134", "ee168", "ee262", "ee265", "cs194w"];
...
function meetsSpecialty(course_array) {
	if (countGradedCourses(course_array, bioelectronicsAndBioimagingArray) >= SPECIALTY_COURSES_REQUIREMENT) {
		return true;
	} else if (countGradedCourses(course_array, circuitsAndDevicesArray) >= SPECIALTY_COURSES_REQUIREMENT) {
		return true;
	} else if (countGradedCourses(course_array, computerHardwareArray) >= SPECIALTY_COURSES_REQUIREMENT) {
		return true;
		...
		if (courseGraded(course_array, "ee141")) {
			if (countGradedCourses(course_array, solidStatePhotonicsAndElectromagneticsArray) > SPECIALTY_COURSES_REQUIREMENT) {
				return true;
			} else if ((courseGraded(course_array, "ee41") || courseGraded(course_array, "engr40p")) && (countGradedCourses(course_array, fundamentalsArray) > FUNDAMENTALS_COURSES_REQUIREMENT)) {
				return true;
			}
		} else {
			return true;
